...
// ⭐ NEW: Import auction status service
import { 
...
// ⭐ NEW: Apply status check middleware to auction and bid routes
// This ensures status updates happen on user activity (backup for free tier)
...
const startServer = async () => {
  try {
    ...
    app.listen(PORT, () => {
      ...
      // ⭐ NEW: Initialize background status checker
